This is the path for com.android.ons smali investigation and every document important of the application all the documents and smali code are from the laboratory device The purpose is only investigation and aport information to the security community

Alex de la cruz México city Sat Aug 22/08/2026
...
## Valid from: Fri Sep 15 02:31:06 EST 2023
## Valid until: Tue Jan 31 02:31:06 EST 2051

## Package: com.android.ons
* Version: 14
* Version code: 34
* Data:  /data/user/0/com.android.ons
* APK (Base package): /system/priv-app/ONS/ONS.apk | 86.5 kB
* Public source directory: /system/priv-app/ONS/ONS.apk
* Device-Protected Data: /data/user_de/0/com.android.ons
* External data:  /storage/emulated/0/Android/data/com.android.ons
* Native libraries directory:  /system/priv-app/ONS/lib/arm64
* UID: 1001
* Install Date: Wed, 2008 Dec 31, 06:00 PM
* Update Date: Wed, 2008 Dec 31, 06:00 PM
* Minimun Sdk: 34, Android 14
* Target Sdk: 34, Android 14
* Method count: Single Dex, 900
* Apex: No
